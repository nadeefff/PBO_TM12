...
public class Matakuliah implements Serializable {
    ...
    private int semesterajar;  // Gunakan tipe int untuk kolom semesterajar
    ...
    public int getSemesterajar() {
        return semesterajar;  // Kembalikan semesterajar sebagai int
    }

    public void setSemesterajar(int semesterajar) {
        this.semesterajar = semesterajar;  // Simpan semesterajar sebagai int
    }
    ...
    public String toString() {
        return "matakuliah3.Matakuliah[ kodemk=" + kodemk + " ]";
    }
}
